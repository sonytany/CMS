...
values ('202206041222', 12, 6, 5, 100000, 'NORMAL');
insert into contract_product(contract_id, product_id, code, name)
values (1, 1, 'TRAVELER', '여행자 보험');
insert into contract_collateral(contract_product_id, collateral_id, code, name, insurable_money, standard_money)
values (1, 1, 'INJURY_PAY', '상해치료비', '1000000', '100');
insert into contract_collateral(contract_product_id, collateral_id, code, name, insurable_money, standard_money)
values (1, 2, 'PLANE_DELAYED_ARRIVAL_PAY', '항공기 지연도착시 보상금', '500000', '100');
