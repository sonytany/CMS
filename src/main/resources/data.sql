insert into product(code, name, period, max_period)
...
--
-- insert into contract(code, start_month, end_month, total_money, status)
-- values ('20220604225459123', 6, 5, 100000, 'NORMAL');
-- insert into contract_product(contract_id, code, name, period)
-- values (1, 'TRAVELER', '여행자 보험', 12);
